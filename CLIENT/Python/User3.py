...
# read the data set
user3 = '/home/yang/Research/Privacy-preserving-DL/MIDDLE_DNN/MIDDLE/CLIENT/Python/userData/user3/mnist_train.tfrecord'
images, labels = MnistInputAll(user3)  # images and labels are lists
