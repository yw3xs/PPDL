...
# read the data set
user2 = '/home/yang/Research/Privacy-preserving-DL/MIDDLE_DNN/MIDDLE/CLIENT/Python/userData/user2/mnist_train.tfrecord'
images, labels = MnistInputAll(user2)  # images and labels are lists
